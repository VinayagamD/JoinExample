...
public class JoinWithOptimizerExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<Integer, String, String>> joined = personSet.join(locationSet, JoinOperatorBase.JoinHint.OPTIMIZER_CHOOSES).where(0).equalTo(0)
                .with((JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>)
                        (Tuple2<Integer,String> person,Tuple2<Integer,String> location) -> new Tuple3<>(person.f0, person.f1, location.f1)).returns(new TupleTypeInfo<>(Types.INT, Types.STRING, Types.STRING)); // returns tuple of (1 John DC)
//        TypeInformation<Tuple3<Integer, String, String>> typeInformation = new TypeHint<Tuple3<Integer, String, String>>() {
//            @Override
...
//                        .with((JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Object>) (person, location) -> new Tuple3<>(person.f0, person.f1, location.f1)));
